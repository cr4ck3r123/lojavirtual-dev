...
//    exit();
//}
include_once("./dao-casaecozinha.php");
...
$num_total = listarCasaCozinhaTotal();
...
<?php foreach (listarCasaCozinha($pagina, $itens_por_pagina) as $row): ?>
                <div class="col-sm-6 col-lg-4 wow fadeInRight" data-wow-delay="0s">
                    <div class="card" style="width: 20rem;">                           
                        <img class="card-img-top" src="<?php echo $row['url_foto']; ?>" alt="Card image cap">
                       
                        <div class="card-body">
                            <form action="saiba_mais_casaecozinha.php" method="GET">
...
<?php for ($i = 0; $i < $num_pagina + 1; $i++) { ?>
            <li class=" <?php if ($i == $pagina) {
        echo 'page-item active';
    } ?>"><a class="page-link" href="?pagina=<?php echo $i ?>"><?php echo $i ?></a></li>
        <?php } ?>         

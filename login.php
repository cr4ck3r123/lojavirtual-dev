...
session_start();
//Substitua {app-id} pelo id do aplicativo 
$fb = new Facebook\Facebook(['app_id' => '1041071169964912',
...
$permission = ['email']; // Permissões opcionais 
$callbackUrl = htmlspecialchars('http://fxoeletronicos.ddns.net/fb-callback.php');
...
<head>
    <title>Shampoo Gelado - Login</title>
                ...
                <div class="col-md-4 login-sec">
                    ...
                    <form class="login100-form validate-form" method="post" action="autenticar.php">
                        ...
                        <div class="text-center p-t-8 p-b-31">
                            <a class="text-danger" href="<?php echo "#"//echo $loginUrl;  ?>">
                                <img class="img" src="https://scontent.figu1-1.fna.fbcdn.net/v/t39.2365-6/17639236_1785253958471956_282550797298827264_n.png?_nc_cat=105&amp;ccb=1-3&amp;_nc_sid=ad8a9d&amp;_nc_ohc=Mwb3q0MpEu8AX9OncqC&amp;_nc_ht=scontent.figu1-1.fna&amp;oh=076e3bbb57742beffdb76f0bf137bd16&amp;oe=6106A056" width="200" alt="">
                            </a>
                        </div>
                        ...
                        <div id="demo" class="carousel slide carousel-fade" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel active">
                                    <img src="images/banner/promocao1.png" height="100%" width="100%">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <form method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="text-dark" for="exampleInputEmail1">Confirme a Senha</label>
            ...
            $.ajax({
                ...
                success: function (mensagem) {
                    ...
                    if (mensagem == 'Cadastrado com Sucesso!!') {
                        ...
                        document.getElementById('senha').value = document.getElementById('pass').value;
